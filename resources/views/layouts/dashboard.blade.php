            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active text-white" aria-current="page" href="{{route('itemgroups')}}">Group Items</a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="collapse navbar-collapse" >
                <ul class="navbar-nav">
                    <li class="nav-item">
                      <h2 class="nav-link active text-white" aria-current="page" href="#" style="font-family: cairo;">Tuwaiq</h2>
                    </li>
                        ...
                        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                            ...
                            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                                <li class="nav-item">
                                   ...
                                   <h2 i class="bi bi-terminal-plus"></i></h2> <span class="ms-1 d-none d-sm-inline text-white">Products</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('addgritem')}}" class="nav-link align-middle px-0">
                                    <h1 i class="bi bi-collection"></i></h1> <span class="ms-1 d-none d-sm-inline text-white">Add Group</span>
                                    </a>
                                </li>
